...
TOKEN = os.getenv('8544868625:AAGT6E1p4hhdLFQz3rPmAFgui-GA4ABSI4I')
OWNER_ID_STR = os.getenv('5994305183')
ADMIN_ID_STR = os.getenv('5994305183')
YOUR_USERNAME = os.getenv('@WhyFlexy')
UPDATE_CHANNEL = os.getenv('@solo_rohan')
...
"""
    ...
    back_keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="💬 Contact Owner", url=f"https://t.me/{Whyflexy.replace('@WhyFlexy', '')}")],
        [InlineKeyboardButton(text="🏠 Main Menu", callback_data="back_to_main")]
    ])
